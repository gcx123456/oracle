...
最好的办法是利用Inter这个工具，架构自己的供需链管理平台，使无处不在的互联网为你所用，实现无处不在的管理目标。让Inter像电一样融入到企业的管理之中，提高企业在新经济时代的核心竞争力，通过对Inter的高效率使用，在激烈的市场竞争中，首先打赢第一仗“信息战”。正是基于对Inter的这种深刻认识，针对中国企业特点提出了基于Inter的网络商务管理解决方案——企业销售管理系统。
